...
import { adminSystemChallengesRoutes } from '@/routes/admin-system-challenges.routes';
...
app.use(`${apiPrefix}/admin/invitations`, adminInvitationRoutes);
app.use(`${apiPrefix}/admin/roles`, adminRoleRoutes);
app.use(`${apiPrefix}/admin/system-challenges`, adminSystemChallengesRoutes);
